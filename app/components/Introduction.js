const Introduction = () => {
    return (
        <div className="grid grid-cols-12  bg-black py-10 align-middle w-screen overflow-hidden">
            <div className="col-start-2 col-end-6">
                <img src="https://static.wixstatic.com/media/a560a5_7e7bc9bca5bc41a8b67f34adb1676e7e~mv2_d_2400_3600_s_4_2.jpg/v1/fill/w_570,h_855,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/bevri_website_gift_card.jpg" className="w-[600px] h-[700px]" />
            </div>
            <div className="col-start-6 col-end-9 text-center ml-20">
                <h1 className="text-5xl font-bold mt-10 text-[#228B22]"><i>Call me Crazy</i></h1>
            ...
            <div className="col-start-10 col-end-12 mt-[180px]">
