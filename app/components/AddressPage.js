const AddressPage = () => {
    return (
        ...
        <div className="flex justify-center items-center gap-20 mx-[400px] my-10">
            <div className="">
        ...
        <div className="flex gap-20 ">
            <img src="https://static.wixstatic.com/media/a560a5_4a4c686df7ed46b7ac7671d2c0b19599~mv2_d_3600_2400_s_4_2.jpg/v1/fill/w_1260,h_640,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/bevri_website_supra.jpg" alt="wine-icon" className="w-[800px] h-[600px]"/>
            <div className="mr-[450px] items-center my-auto">
